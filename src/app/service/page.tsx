          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-8">
            ...
            {services.length === 0 && (
              <div className="col-span-full py-10 text-center">
                <p className="text-slate-400 font-medium italic">No trending services at the moment</p>
              </div>
            )}
          </div>
        </div>
      ...
      <section id="service-categories" className="py-10 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6">
            ...
            {categories.length === 0 && (
              <div className="col-span-full py-10 text-center">
                <p className="text-slate-400 font-medium">Loading service categories...</p>
              </div>
            )}
          </div>
        </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
            ...
            <div className="w-full lg:w-1/2 text-center lg:text-left space-y-8">
              <div className="space-y-4">
                <div className="inline-block px-4 py-1.5 bg-blue-100 text-blue-700 rounded-full text-sm font-bold mb-2">
                  Mobile App
                </div>
              ...
              <div className="pt-4 flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                ...
                <button className="group bg-slate-900 text-white px-6 py-3.5 rounded-xl flex items-center gap-3 hover:bg-slate-800 transition-all duration-300 hover:scale-105 shadow-xl shadow-slate-900/20">
                  ...
                  <div className="text-left">
                    <div className="text-[10px]  font-bold  opacity-70">Download on the</div>
                ...
                <button className="group bg-slate-900 text-white px-6 py-3.5 rounded-xl flex items-center gap-3 hover:bg-slate-800 transition-all duration-300 hover:scale-105 shadow-xl shadow-slate-900/20">
                  ...
                  <div className="text-left">
                    <div className="text-[10px] font-bold opacity-70">Get it on</div>
