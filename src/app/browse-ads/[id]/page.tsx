...
export default function ProductDetailsPage() {
  ...
  const dailyPrice = Math.round(monthlyPrice / 30 * 1.5);
  const totalPrice = activeTab === 'monthly' ? monthlyPrice : dailyPrice * days;

  const allImages = productDetails
    ? [productDetails.product_main_image, ...(productDetails.images || []).map((img: any) => img.image || img)].filter(Boolean)
    : [];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 lg:gap-0">
            ...
            <div className="bg-gray-50/70 p-5 lg:p-10 flex items-center justify-center border-r border-gray-100">
              <div className="w-full max-w-[520px]">
                <div className="relative rounded-2xl overflow-hidden shadow-lg bg-white border border-gray-200 aspect-[4/3.2]">
                  <img
                    src={selectedImage || 'https://via.placeholder.com/720x540?text=Product'}
            ...
            <div className="p-6 lg:p-10 xl:p-12 flex flex-col">
              <div>
                ...
                {/* Rental Type Tabs */}
                <div className="mb-7">
                  <label className="text-sm font-semibold text-slate-900  mb-2.5 block">Select Rental Type</label>
                ...
                {activeTab === 'monthly' ? (
                  <div className="space-y-7">
                    {productDetails?.month_arrr?.length > 0 ? (
                          ...
                          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3.5">
                            {productDetails.month_arrr.map((monthData: any, idx: number) => {
                              ...
                              return (
                                ...
                                >
                                  <div className="text-base font-bold text-gray-900">{months} Months</div>
                      ...
                      <div className="py-10 text-center text-gray-500">Monthly plans not available</div>
                    )}
                  </div>
                ) : (
                    ...
                    {productDetails?.product_listing_type_name?.toLowerCase() === 'daily' ? (
                      <div className="p-6 border border-gray-200 rounded-xl bg-gray-50/40">
                        <div className="flex items-center justify-between mb-5">
                          <span className="font-semibold text-gray-700">Rental Days</span>
                          <div className="flex items-center bg-white border rounded-lg shadow-sm">
                            ...
                            <span className="w-12 text-center font-bold text-lg">{days}</span>
                            <button
                        ...
                        <div className="grid grid-cols-2 gap-4 pt-4 border-t">
                          <div>
                            ...
                            <div className="text-xl font-bold">₹{dailyPrice.toLocaleString()}</div>
                          </div>
                      ...
                      <div className="py-10 text-center text-gray-500">Daily rental not available</div>
                    )}
                  </div>
                )}
                  ...
                  <Button
                    ...
                    onClick={() =>
                      console.log({
                        ...
                        type: activeTab,
                        quantity,
                        days: activeTab === 'daily' ? days : undefined,
                        months: activeTab === 'monthly' ? selectedDuration : undefined,
                        deliveryDate,
                      })
                    }
                  >
